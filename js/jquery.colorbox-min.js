...
;(function(t, e, i) {
  ...
  function f(i) {
    ...
    if (!G) {
      ...
      v.css({ opacity: p === p ? p : "", cursor: _.get("overlayClose") ? "pointer" : "", visibility: "visible" }).show(),
          ...
          t(e).bind("keydown." + Z, function(t) {
            ...
            U && _.get("escKey") && 27 === e && (t.preventDefault(), J.close()),
              U &&
                ...
                W[1] &&
                !t.altKey &&
                (37 === e ? (t.preventDefault(), P.click()) : 39 === e && (t.preventDefault(), K.click()))
          }),
              ...
              d === le &&
                setTimeout(function() {
                  ...
                  _.get("retinaImage") &&
                    ...
                    ((q.height = q.height / i.devicePixelRatio), (q.width = q.width / i.devicePixelRatio)),
                    _.get("scalePhotos") &&
                      ((o = function() {
    ...
    ce = (function() {
      ...
      return function() {
        r
          ...
          : _.get("slideshow") && W[1] && ((r = !0), ae.one(oe, o), _.get("slideshowAuto") ? i() : n(), S.show())
      }
    })()
  t[Y] ||
    (t(p),
